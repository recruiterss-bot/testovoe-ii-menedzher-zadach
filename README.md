...
AI Task Manager — это менеджер задач с ИИ-помощником для повседневной работы.  
Он помогает быстрее разбирать входящий поток задач: предлагает приоритет, категорию, декомпозицию на шаги и сводку по загрузке.  
ИИ ничего не применяет автоматически, все изменения подтверждаются вручную.  
